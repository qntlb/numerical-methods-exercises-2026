package exercises.usefulmethodsmatricesandvectors;
...
public class UsefulMethodsMatricesAndVectors {
	...
	// a matrix is an array of arrays
		...
		/**
		 * Computes the standard deviation of a vector given as an argument
		 *
		 * @param vector
		...
		/**
		 * Returns the biggest element of a one-dimensional array of doubles
		 *
		...
		/**
		 * Returns an array of integers which represent the number of realizations of
		...
		/**
		 * Returns a vector whose values are the absolute values of a vector given as
		 * an argument
		 *
		...
		/**
		 * Returns the product of a vector with a (constant) double
		 *
		 * @param vector
		...
		/**
		 * Returns the sum of a vector with a (constant) double
		 *
		 * @param vector
		 * @param value, to the double number that we sum to the vector
		...
		/**
		 * Returns the element-wise ratio of two vectors
		 *
		 * @param firstVector
		 * @param secondVector
