 ...
 * fields of the class. It also has a method frequencyOfInterval which returns
...
public abstract class MeanConfidenceInterval {
	...
	//Two abstract methods. The confidence interval is specific to the method used to compute it.
	/**
